...
export const zh = {
  ...
  sideChatBlockCodeLabel: '代码块',
  sideChatBlockWrap: '自动换行',
  sideChatBlockUnwrap: '取消自动换行',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  sideChatBlockNoExitCode: 'no exit code',
  sideChatBlockCodeLabel: 'Code block',
  sideChatBlockWrap: 'Wrap lines',
  sideChatBlockUnwrap: 'Do not wrap lines',
