export const pt: Record<string, string> = {
  ...
  sideChatBlockNoExitCode: 'sem código de saída',
  sideChatBlockCodeLabel: 'Bloco de código',
  sideChatBlockWrap: 'Quebrar linhas',
  sideChatBlockUnwrap: 'Não quebrar linhas',
