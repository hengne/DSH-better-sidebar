...
export const hi: Record<string, string> = {
  ...
  sideChatBlockNoExitCode: 'कोई एग्ज़िट कोड नहीं',
  sideChatBlockCodeLabel: 'कोड ब्लॉक',
  sideChatBlockWrap: 'पंक्तियाँ रैप करें',
  sideChatBlockUnwrap: 'पंक्तियाँ रैप न करें',
